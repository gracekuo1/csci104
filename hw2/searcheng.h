...
private:
    ...
    std::string fname;
    std::string term;
    //term and all the associated webpages
    std::map <std::string, WebPageSet> term_webpages;

    //file name and the webpage associated with it
    std::map <std::string, WebPage*> file_pages;
